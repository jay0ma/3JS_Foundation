...
#define LOW_PRECISION`),t}function Em(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===zc?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Bc?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===bn&&(t="SHADOWMAP_TYPE_VSM"),t}function wm(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Bi:case Gi:t="ENVMAP_TYPE_CUBE";break;case ar:t="ENVMAP_TYPE_CUBE_UV";break}return t}function bm(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Gi:t="ENVMAP_MODE_REFRACTION";break}return t}function Tm(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Gc:t="ENVMAP_BLENDING_MULTIPLY";break;case ah:t="ENVMAP_BLENDING_MIX";break;case ch:t="ENVMAP_BLENDING_ADD";break}return t}function Am(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Cm(r,t,e,n){const i=r.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=Em(e),l=wm(e),h=bm(e),d=Tm(e),u=Am(e),f=e.isWebGL2?"":pm(e),g=mm(e),_=gm(s),m=i.createProgram();let p,v,x=e.glslVersion?"#version "+e.glslVersion+`
